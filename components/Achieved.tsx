...
const Achieved = () => {
    const { awards, memberships, loading } = usePortfolioData();
    ...
    if (loading) {
        return (
            <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center">
    ...
    return (
        <section className="bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:px-8 lg:px-16 py-16 scroll-mt-24" id="achieved">
            ...
            {/* Awards Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16 items-stretch max-w-7xl mx-auto">
                {awards.map((award, index) => (
                    <div key={index} className="award-card bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow p-6 border-t-4 border-transparent hover:border-blue-500 flex flex-col">
                        ...
                        <div className="flex items-start justify-between mb-3">
                            ...
                            <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap ml-2">{award.year}</span>
                        </div>
                ...
                <div className="mt-16 max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {memberships.map((membership, index) => (
                            <div key={index} className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-l-4 border-purple-500">
            ...
            {/* Impact Statistics */}
            <div className="mt-16 p-8 bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl shadow-2xl max-w-7xl mx-auto">
                <h3 className="text-4xl font-bold text-white mb-8 text-center bebas-neue-regular">Academic Impact & Reach</h3>
            ...
            {/* Research Philosophy */}
            <div className="mt-16 p-8 bg-white rounded-2xl shadow-lg border-l-4 border-blue-500 max-w-7xl mx-auto">
